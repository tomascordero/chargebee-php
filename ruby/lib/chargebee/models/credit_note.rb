module ChargeBee
  ...
  :status, :vat_number, :date, :price_type, :total, :credits_allocated, :refunds_made, :remaining_credits,
  :paid_at, :sub_total, :line_items, :discounts, :taxes, :linked_refunds, :allocations
