...
'status', 'vatNumber', 'date', 'priceType', 'total', 'creditsAllocated', 'refundsMade', 'remainingCredits','paidAt', 'subTotal', 'lineItems', 'discounts', 'taxes', 'linkedRefunds', 'allocations');
