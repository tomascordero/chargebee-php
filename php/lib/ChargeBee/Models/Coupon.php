...
'discountQuantity', 'durationType', 'durationMonth', 'validTill', 'maxRedemptions', 'status','redemptions', 'applyDiscountOn', 'applyOn', 'applicablePlans', 'applicableAddons', 'createdAt','archivedAt', 'planIds', 'addonIds');
